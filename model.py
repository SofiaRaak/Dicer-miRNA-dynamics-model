...
def toy_model(t, init_values): #not bothering with passing reaction rates since not optimising
    ...
    #Proper model - needs to be automated for more miRNAs
    ...
    premirna1_dicer = init_dicer*init_premirna1*ka1 - init_premirna1_dicer*(ka_1 + ka2)
    premirna2_dicer = init_dicer*init_premirna2*kb1 - init_premirna2_dicer*(kb_1 + kb2)
    premirna3_dicer = init_dicer*init_premirna3*kc1 - init_premirna3_dicer*(kc_1 + kc2)
    premirna4_dicer = init_dicer*init_premirna4*kd1 - init_premirna4_dicer*(kd_1 + kd2)
    premirna5_dicer = init_dicer*init_premirna5*ke1 - init_premirna5_dicer*(ke_1 + ke2)
    ...
    dicer = (init_premirna1_dicer*(ka_1 + ka2) + init_premirna2_dicer*(kb_1 + kb2) + 
            ...
            init_dicer*(init_premirna1*ka1 + init_premirna2*kb1 + init_premirna3+kc1 +
                        init_premirna4*kd1 + init_premirna5*ke1)
